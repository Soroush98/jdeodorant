...
public class DrawNewCFG extends JPanel {
   ...
   public static void createAndShowGui(CFG cfg) {
      DrawNewCFG mainPanel = new DrawNewCFG();
      mainPanel.cfg = cfg;
